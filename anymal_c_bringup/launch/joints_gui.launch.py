...
def generate_launch_description():
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package="anyma_c_config").find("anymal_c_config")
    config = os.path.join(pkg_share, "config/joints/joints.yaml")

    declare_description_name = DeclareLaunchArgument("description_name", default_value="anymal_c", description="Robot description")
