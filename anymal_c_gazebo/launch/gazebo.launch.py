...
def generate_launch_description():
    ...
    gz_pkg_share = launch_ros.substitutions.FindPackageShare(package="anymal_c_gazebo").find(
        "anymal_c_gazebo"
    )
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package="anymal_c_simple_description").find("anymal_c_simple_description")
    default_model_path = os.path.join(pkg_share, "urdf/anymal_main.xacro")
    ...
    gazebo_config = os.path.join(launch_ros.substitutions.FindPackageShare(
        package="anymal_c_gazebo"
    ).find("anymal_c_gazebo"), "config/gazebo.yaml")
